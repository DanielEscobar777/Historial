...
<div class="col-md-12 col-12">
    <div class="panel" data-sortable-id="ui-general-1">
        ...
        <div class="panel-body">
            ...
            <form action="{{ route('evolucion.store_temp') }}" method="POST" autocomplete="off" novalidate>
                @csrf
                 @method('POST')
                <div class="row">
                    <div class="col-md-10">
                ...
                <tbody>
                    ...
                    <tr class="align-middle">
                        ...
                        <td class="text-center">
                            <form action="{{ route('evolucion.delete',$diagnostico->id_temporal)}}" method="POST" style="display: inline-block" onsubmit="return confirm('DESEA ELIMINAR EL REGISTRO')">
                                @csrf
                                @method('DELETE')
                                <input type="hidden" class="form-control" name="id_historial" value="{{ $id_historial}}" required>
            ...
            <button class="btn btn-success" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><i class="fa fa-share"></i>Continuar</button>
        </div>
