...
return new class extends Migration
{
    ...
    {
        Schema::create('au_antecedentes_inmunizacion', function (Blueprint $table) {
            $table->increments('id_au_ant_inmunizacion');
            $table->integer('id_historial')->nullable();
            $table->text('antecedentes_inmunizacion')->nullable();
    ...
    {
        Schema::dropIfExists('au_antecedentes_inmunizacion');
    }
};
