...
return new class extends Migration
{
    ...
    {
        Schema::create('au_examen_fisico_segmentado', function (Blueprint $table) {
            $table->increments('id_au_exm_segmentado');
    ...
    {
        Schema::dropIfExists('au_examen_fisico_segmentado');
    }
};
